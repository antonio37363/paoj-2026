...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Frecvență: " + map);
        System.out.println("Conține 'rust'? " + map.containsKey("rust"));
        System.out.println("Chei: " + map.keySet());
        System.out.println("Valori: " + map.values());
